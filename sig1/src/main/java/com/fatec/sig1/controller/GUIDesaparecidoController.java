...
public class GUIDesaparecidoController {
	...
	public ModelAndView retornaFormParaEditarDesaparecido(@PathVariable("cpf") String cpf) {
		ModelAndView modelAndView_desaparecido = new ModelAndView("atualizarDesaparecido");
		modelAndView_desaparecido.addObject("desaparecido", servico_desaparecido.consultaPorCpf(cpf).get()); // retorna um objeto do tipo cliente
