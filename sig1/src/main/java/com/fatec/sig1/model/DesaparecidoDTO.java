...
public class DesaparecidoDTO {
	...
	public DesaparecidoDTO(String nomeCompletoDesaparecido,
	...
	public Desaparecido retornaUmDesaparecido() {
		return new Desaparecido(nomeCompletoDesaparecido,dataDeNascimento,
				 dataDeDesaparecimento,
				 horaDeDesaparecimento,
				 cpfDoDesaparecido,
				 recompensa,
				 urlFotoPrincipal,
				 altTxtFotoPrincipal,
				 descricaoDesaparecimento,
				 doenca,
				 sexo_desaparecido,
				 corDePele);
	}
