 ...
 */
@Repository
public interface DesaparecidoRepository extends JpaRepository<Desaparecido, Long> {
	Optional<Desaparecido> findByCpfDoDesaparecido(String cpfDoDesaparecido);

	List<Desaparecido> findAllByNomeIgnoreCaseContaining(String nomeCompletoDesaparecido);
}
